      ...
      <section className="card border-0 shadow-sm consortium-account-card">
        <div className="card-body p-4">
          ...
          <div className="row g-3 mb-4">
            <div className="col-md-6 col-xl-3"><div className="rounded bg-light p-3 h-100"><small className="text-muted text-uppercase">Cargos emitidos</small><strong className="fs-5 d-block consortium-money">{formatConsortiumMoney(summary.charges, currency)}</strong></div></div>
