...
const PERMISSION_LABELS = {
    ...
    canViewTasaciones: "ver tasaciones",
    canCreateTasaciones: "crear tasaciones",
    canEditTasaciones: "editar tasaciones",
    canViewRentals: "ver contratos y movimientos de alquileres",
    canManageRentals: "gestionar contratos, cobros y liquidaciones",
    canViewConsortiums: "ver consorcios, unidades y cuentas corrientes",
    canManageConsortiums: "gestionar liquidaciones, expensas y cobros",
    canViewTaxes: "ver objetos y obligaciones tributarias",
    canManageTaxes: "gestionar obligaciones y pagos tributarios",
